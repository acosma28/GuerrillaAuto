...
const Contact = () => {
  ...
  return (
    <div className="Guerrilla_tm_section" id="contact">
      <div className="Guerrilla_tm_contact">
              ...
              <ul>
                ...
                <li>
                  <div className="list_inner">
                    ...
                    <span>Email</span>
                    <h3>
                      <a className="line_anim" href="mailto:hello@Guerrilla.com">
                        contact@Guerrilla.com
                      </a>
                    </h3>
                  </div>
                </li>
                ...
                >
                  ...
                  <div className="Guerrilla_tm_button">
                    <a id="send_message" href="#" onClick={() => onSubmit()}>
                      <span>Send Message {msgSent}</span>
                    </a>
                  </div>
